...
// Убрана функция sanitizeStreamingMarkdown - она ломала markdown,
// добавляя backticks при наличии тройных кавычек (```)
// react-markdown сам корректно обрабатывает незавершенный markdown
